...
export const SOCIALS: SocialObjects = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/filledstacks/",
    linkTitle: `${SITE.title} on Instagram`,
    active: true,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/dane-mackier-a0b99670",
    linkTitle: `${SITE.title} on LinkedIn`,
    active: true,
  },
  {
    name: "Mail",
    href: "mailto:dane@filledstacks.com",
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@FilledStacks",
